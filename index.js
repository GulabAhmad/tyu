...
//console.log(person) 
var person = "Gulab Ahmad";
console.log(person);
var num1 = 3434;
console.log(num1);
var num2 = 4546464;
console.log(num2);
var person1 = "Hello Eric, would you like to learn python today?";
console.log(person1);
var person2 = "Gulab Ahmad";
console.log(person2);
...
console.log(person2.split(""));
var author = "Albert Einstein once said, “A person who never made a mistake never tried anything new.”";
console.log(author);
...
var message = " Hello ${famous_person},A person who never made a mistake never tried anything new.";
console.log(message);
var personName = "\t Gulab Ahmad \n";
console.log(personName);
var strippedpersonName = personName.trim();
console.log(strippedpersonName);
var personNameWithWhitespace = "\t HP ELITEBOOK";
console.log("Name with whitespace:");
console.log(personNameWithWhitespace);
var trimPersonName = personNameWithWhitespace.trim();
...
let motorbikes = ["Honda", "Yamaha", "Kawasaki", "Harley-Davidson"];
for (let i = 0; i < motorbikes.length; i++) {
    console.log(`I would like to own a ${motorbikes[i]} motorcycle.`);
}
let guestinvite = ["Muhammad Umar", "Umar liquait", "Ibrahim", "Abu Bakar"];
...
let guestList = ["Albert Einstein", "Nelson Mandela", "Jane Austen"];
// Removing the guest who can't make it
let guestWhoCantMakeIt = "Jane Austen";
let indexToRemove = guestList.indexOf(guestWhoCantMakeIt);
if (indexToRemove !== -1) {
...
const placeToVisit = ["Machu Picchu", "Santorini", "Kyoto", "Iceland", "New York City",];
